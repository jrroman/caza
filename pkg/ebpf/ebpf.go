...
func eBPFReadLoop(rd *ringbuf.Reader, ec chan *NetworkPair) {
	...
	for {
		...
		ec <- newNetworkPair(srcAddr, dstAddr, srcPort, dstPort)
	}
}

func LoadAndRun(ec chan *NetworkPair) {
